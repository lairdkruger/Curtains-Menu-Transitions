var ditherShader = {
    ...
    fragmentShader: `
        ...
        void main () {
            ...
            vec3 oldColor = texture2D(textureActive, vTextureActiveCoord).rgb;
            vec3 newColor = texture2D(nextTexture, vNextTextureCoord).rgb;
            ...
            vec3 mixColor = mix(oldDither.rgb, newDither.rgb, uProgress);
